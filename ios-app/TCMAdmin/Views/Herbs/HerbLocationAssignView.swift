    ...
    public var body: some View {
        Form {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 4) {
                                    Text(herb.name)
                                        ...
                                        .foregroundStyle(editingHerbId == herb.id ? Color.appPrimary : Color.ink)
                                ...
                                Image(systemName: "pencil")
                                    .foregroundStyle(editingHerbId == herb.id ? Color.appPrimary : Color.muted)
                            }
                        }
                    }
                }
                ...
                Section(header: Text("货位位置与分类")) {
                    ...
                    HStack {
                        ...
                        Text(computedLocationCode.isEmpty ? "等待输入..." : computedLocationCode)
                            ...
                            .foregroundStyle(computedLocationCode.isEmpty ? Color.muted : Color.appPrimary)
                    }
                }
            } else {
            ...
            if let error = errorMessage {
                Section {
                    Text(error).foregroundStyle(Color.danger).scaledFont(13)
                }
            }
