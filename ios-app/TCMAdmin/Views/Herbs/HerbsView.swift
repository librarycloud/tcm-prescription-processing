    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if isLoading && data == nil {
                ...
                Spacer()
                Text(error).foregroundColor(.danger)
                                ...
                                VStack(alignment: .leading, spacing: 12) {
                                    ...
                                    ForEach(unit.locations) { loc in
                                        VStack(alignment: .leading, spacing: 4) {
                                            ...
                                            Text(loc.typeLabel).font(.system(size: (11) * ThemeManager.shared.fontScale)).foregroundColor(.muted)
                                            ...
                                            if let herbs = loc.herbs, !herbs.isEmpty {
                                                ...
                                                Text("未配置药材（空置）").font(.system(size: (12) * ThemeManager.shared.fontScale)).foregroundColor(.muted)
                                                    .padding(.top, 2)
                                            }
                                        }
