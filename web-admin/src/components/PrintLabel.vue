...
const props = defineProps({
  ...
  equipmentInfo: { type: Object, default: null },
...
function fieldValue(field) {
  ...
  const item = props.equipmentInfo || props.planInfo || props.packageInfo || {};
  ...
  const values = {
    ...
    customerName: prescription.customerName || item.customerName || '-',
    ...
    processRemark: `加工备注：${item.processRemark || item.remark || '-'}`,
