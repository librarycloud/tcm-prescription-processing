...
function openManualBatch() { if (!selectedCandidateProduct.value) return; Object.assign(countForm, { mode: 'initial', id: null, product: selectedCandidateProduct.value, batchNo: '', location: '', manualBatch: true, editing: false, systemQty: 0, qty: 0 }); countDialog.value = true; }
