...
internal class DifferencesPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, JSONObject> {
        ...
        return try {
            val response = if (tab == "current") {
                apiClient.differenceProductsPaged(page = page, pageSize = 20)
            } else {
                apiClient.differenceLogsPaged(page = page, pageSize = 20)
            }
